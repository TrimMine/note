...
class Ethereum extends JSON_RPC
{
    ...
    function personal_newAccount($input)
    {
        return $this->ether_request(__FUNCTION__, $input);
    }

    function personal_importRawKey($input)
    {
        return $this->ether_request(__FUNCTION__, $input);
    }

    function personal_unlockAccount($input)
    {
        return $this->ether_request(__FUNCTION__, $input);
    }
    function personal_lockAccount($input)
    {
        return $this->ether_request(__FUNCTION__, $input);
    }

    function personal_sign($input)
    {
        return $this->ether_request(__FUNCTION__, $input);
    }

    function personal_ecRecover($input)
    {
        return $this->ether_request(__FUNCTION__, $input);
    }
    function personal_sendTransaction($input)
    {
        return $this->ether_request(__FUNCTION__, $input);
    }
